...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('main_phone_country', 2)->default('XX');
            $table->string('mobile_phone')->nullable();
            $table->string('mobile_phone_country', 2)->default('XX');
            $table->string('home_phone')->nullable();
            $table->string('home_phone_country', 2)->default('XX');
            $table->string('work_phone')->nullable();
            $table->string('work_phone_country', 2)->default('XX');
            $table->string('fax_phone')->nullable();
            $table->string('fax_phone_country', 2)->default('XX');
            ...
            $table->string('whatsapp_phone_country', 2)->default('XX');
            $table->string('telegram_phone')->nullable();
            $table->string('telegram_phone_country', 2)->default('XX');
            $table->string('viber_phone')->nullable();
            $table->string('viber_phone_country', 2)->default('XX');
